...
from env import OPEN_CHARGE_MAP_API_KEY
...
def main():
    ...
    ocm_url = f"https://api.openchargemap.io/v3/poi/?output=json&key=${OPEN_CHARGE_MAP_API_KEY}&countrycode=NL&maxresults=1000"
